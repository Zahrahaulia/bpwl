...
<?php
	...
	$result = mysqli_query($conn, "SELECT monthname(bulan)as  bulan,jumlahPendaftar,jumlahDiterima FROM penerimaan ORDER BY  MONTH(bulan) DESC"); // using mysqli_query insted
...
var data = {
    ...
    series: [
        {
            name: 'Laki-Laki',
            data: [500, 300, 250, 700, 600, 400]
        },
        {
            name: 'Perempuan',
            data: [800, 100, 300, 200, 500, 300]
        }
    ]
};
...
var options = {
    chart: {
        width: 1160,
        height: 650,
        title: 'Grafik Data Laporan Kedatangan Penduduk Datang Masuk Ke DKI Jakarta',
        format: '1,000'
    },
    yAxis: {
        title: 'Bulan'
...
tui.chart.colummChart(container, data, options);
</script>
